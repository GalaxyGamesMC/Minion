...
use CLADevs\Minion\database\utils\BinaryStringParser;
use CLADevs\Minion\database\utils\BinaryStringParserInstance;
...
class Database implements DatabaseStmts{
     ...
     */
    public function __construct(Main $plugin, array $configuration){
